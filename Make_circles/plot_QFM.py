...
def plot_QFM(ansatz, qubits, layers, params):
    ...
    X_C1_Q0 = np.array([datos_clase1_Q0[j][0] for j in range(len(X_class1))])
    Y_C1_Q0 = np.array([datos_clase1_Q0[j][1] for j in range(len(X_class1))])
    Z_C1_Q0 = np.array([datos_clase1_Q0[j][2] for j in range(len(X_class1))])
    label_1 = np.ones(len(X_C1_Q0))

    # Componentes qubit 0, clase 2
    X_C2_Q0 = np.array([datos_clase2_Q0[j][0] for j in range(len(X_class2))])
    Y_C2_Q0 = np.array([datos_clase2_Q0[j][1] for j in range(len(X_class2))])
    Z_C2_Q0 = np.array([datos_clase2_Q0[j][2] for j in range(len(X_class2))])
    ...
    X_C1_Q1 = np.array([datos_clase1_Q1[j][0] for j in range(len(X_class1))])
    Y_C1_Q1 = np.array([datos_clase1_Q1[j][1] for j in range(len(X_class1))])
    Z_C1_Q1 = np.array([datos_clase1_Q1[j][2] for j in range(len(X_class1))])
    label_1 = np.ones(len(X_C1_Q1))

    # Componentes qubit 1, clase 2
    X_C2_Q1 = np.array([datos_clase2_Q1[j][0] for j in range(len(X_class2))])
    Y_C2_Q1 = np.array([datos_clase2_Q1[j][1] for j in range(len(X_class2))])
    Z_C2_Q1 = np.array([datos_clase2_Q1[j][2] for j in range(len(X_class2))])
